...
public static class MAST_Placement_Place
{
    ...
    public static GameObject PlacePrefabInScene()
    {
            ...
            MAST_Placement_Visualizer.GetGameObject() != null)
        {
            ...
            GameObject newPrefab = (GameObject) PrefabUtility.InstantiatePrefab(MAST_Prefab_Palette.GetSelectedPrefab());
            ...
            newPrefab.name = MAST_Prefab_Palette.GetSelectedPrefab().name;
            ...
            if (collider.gameObject.transform.parent != null)
            {
                ...
                if (nearObject.name != "MAST_Visualizer")
                {
                        ...
                        MAST_Placement_Visualizer.GetGameObject().transform.position)
                    {
                        ...
                        if (!MAST_Placement_Helper.GetPlaceInsideOthers())
                            if (!nearComponent.placeInsideOthers)
                            {

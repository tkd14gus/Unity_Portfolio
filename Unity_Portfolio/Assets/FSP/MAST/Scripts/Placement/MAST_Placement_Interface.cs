...
// ---------------------------------------------------------------------------
    ...
    public static void ChangeSelectedPrefab()
    {
        ...
        MAST_Placement_Helper.mastScript = 
            MAST_Prefab_Palette.GetSelectedPrefab().GetComponent<MAST_Prefab_Component>();
        
        // Remove any existing visualizer
        MAST_Placement_Visualizer.RemoveVisualizer();
        
        // Create a new visualizer
        MAST_Placement_Visualizer.CreateVisualizer(MAST_Prefab_Palette.GetSelectedPrefab());
    }

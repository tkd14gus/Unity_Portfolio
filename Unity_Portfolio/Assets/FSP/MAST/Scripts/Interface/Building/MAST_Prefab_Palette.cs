...
public class MAST_Prefab_Palette
{
    // Persistent access to the MAST_Prefab_Palette_IO Class
    private static MAST_Prefab_Palette_IO PaletteIOClass;
    private static MAST_Prefab_Palette_IO PaletteIO
    {
        get
        {
            if(PaletteIOClass == null)
                PaletteIOClass = new MAST_Prefab_Palette_IO();

...
public class MAST_Material_Palette
{
    // Persistent access to the MAST_Material_Palette_IO Class
    private static MAST_Material_Palette_IO PaletteIOClass;
    private static MAST_Material_Palette_IO PaletteIO
    {
        get
        {
            if(PaletteIOClass == null)
                PaletteIOClass = new MAST_Material_Palette_IO();
